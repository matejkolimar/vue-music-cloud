...
export default {
  ...
  data() {
    return {
      song: {},
      commentSchema: { comment: "required|min:3" },
      comment_in_submission: false,
      comment_show_alert: false,
      comment_alert_variant: "bg-blue-500",
      comment_alert_message: "Please wait! Your comment is beign submitted",
      comments: [],
      sort: "1",
    };
  },
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.comment_alert_message = "Please wait! Your comment is beign submitted";
